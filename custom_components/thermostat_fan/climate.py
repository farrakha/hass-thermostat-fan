...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend(
    {
        ...
        vol.Optional(CONF_INITIAL_HVAC_MODE): vol.In(
            [HVACMode.COOL, HVACMode.HEAT, HVACMode.OFF, HVACMode.AUTO, HVACMode.FAN_ONLY, HVACMode.DRY],
        ),
...
async def async_setup_platform(
    ...
    attr_hvac_modes = config.get(CONF_MODE_LIST)
    attr_fan_modes = config.get(CONF_FAN_MODE_LIST)
...
class ThermostatFan(ClimateEntity, RestoreEntity):
